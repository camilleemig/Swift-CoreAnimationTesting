...
//  CoreAnimationTesting
//
//  Created by Camille Emig on 4/12/19.
//  Copyright © 2019 Camille Emig. All rights reserved.
//
...
class CountdownProgressBar: UIView {
    ...
    // layer that will show the remaining time
    ...
    private lazy var backgroundLayer: CAShapeLayer = {
        ...
        backgroundLayer.strokeColor = UIColor.clear.cgColor //UIColor.lightGray.cgColor
    ...
    private lazy var pulseLayer: CAShapeLayer = {
        ...
        pulseLayer.strokeColor = UIColor.clear.cgColor //UIColor.lightGray.cgColor
    ...
    private func loadLayers() {
        ...
        // set the start angle to be 12 o'clock and the end angle to be 360 degrees clockwise
        ...
        // add the background CAShapeLayer and the 2 CAGradientLayers as a sublayer
